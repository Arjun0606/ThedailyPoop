# 🚀 Plop TestFlight Deployment Guide

## 📋 Pre-Flight Checklist

### ✅ Current App Configuration
- **App Name:** Plop
- **Bundle ID:** `com.plopapp.app`
- **Version:** 1.0
- **Build:** 1
- **Team ID:** UDGYWMWVJS
...
### 1.1 Open Xcode
```bash
cd /Users/arjun/plopapp
open Plop.xcodeproj
```

### 1.2 Configure Signing & Capabilities
1. Click on **Plop** (blue icon) in the Project Navigator
2. Select **Plop** target
...
- **Bundle ID:** `com.plopapp.app` (select from dropdown)
- **SKU:** `plopapp-2025` (or any unique identifier)
...
- Located in: `Plop/Assets.xcassets/AppIcon.appiconset/`
- Size: 1024×1024 PNG
...
**Privacy Policy URL:** https://plopapp.app/privacy
...
1. In App Store Connect, open your Plop app
...
2. Fill in **Test Information:**
   ...
   - **Marketing URL:** https://plopapp.app (optional)
   - **Privacy Policy URL:** https://plopapp.app/privacy
...
### 7.3 Test the App
Launch Plop and test all features! 🎉
...
1. **Increment Build Number** (in Xcode):
   - Select Plop project → Target → General
   - Build: `1` → `2`, `3`, etc.
...
**Solution:** Ensure Bundle ID matches App Store Connect exactly (`com.plopapp.app`)
