...
struct SpinTheExcuseCardView: View {
    let game: ExcuseGame?
    let isPremium: Bool
    let onPlay: () -> Void
    let onUpgrade: () -> Void
    ...
    private let gameColor = Color.orange
            ...
            HStack(spacing: 14) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    if let game, game.played, let score = game.userScore {
                        ...
                        Text("Spotted the real PR excuse")
                            .font(.caption2)
                            .foregroundStyle(Theme.textTertiary)
                    } else if isLocked {
                        Text("Spot the real excuse")
                            .font(.subheadline.weight(.medium))
                            .foregroundStyle(.white)
                        Text("5 rounds \u{00B7} pick the real PR spin")
                            .font(.caption2)
                            .foregroundStyle(Theme.textTertiary)
                    } else if game != nil {
                        Text("Spot the real excuse")
                            .font(.subheadline.weight(.medium))
                            .foregroundStyle(.white)
                        Text("5 rounds \u{00B7} 4 options each")
                            .font(.caption2)
                            .foregroundStyle(Theme.textTertiary)
                    } else if !isLocked {
                        Text("Coming soon...")
