                    ...
                    VStack(spacing: 24) {
                        ...
                        VStack(spacing: 16) {
                            ...
                            ContactButton(
                                ...
                                action: {
                                    if let url = URL(string: "mailto:karjunvarma2001@gmail.com?subject=Plopper%20Feedback") {
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            VStack(spacing: 12) {
                                QuickActionButton(
                                    ...
                                    if let url = URL(string: "mailto:karjunvarma2001@gmail.com?subject=Plopper%20Feature%20Request") {
                                        UIApplication.shared.open(url)
                                    }
                                }
                                ...
                                QuickActionButton(
                                    ...
                                    if let url = URL(string: "mailto:karjunvarma2001@gmail.com?subject=Plopper%20Bug%20Report") {
                                        UIApplication.shared.open(url)
                                    }
                                }
